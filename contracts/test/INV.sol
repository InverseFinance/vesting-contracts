...
contract INV {
    ...
    function mint(address dst, uint256 rawAmount) external {
        ...
        totalSupply = safe96(totalSupply + amount, "INV::mint: totalSupply exceeds 96 bits");
    ...
    function permit(
        ...
        require(block.timestamp <= deadline, "INV::permit: signature expired");
    ...
    function transferFrom(
        ...
        if (spender != src && spenderAllowance != type(uint96).max) {
            uint96 newAllowance =
                sub96(spenderAllowance, amount, "INV::transferFrom: transfer amount exceeds spender allowance");
    ...
    function delegateBySig(
        ...
        require(block.timestamp <= expiry, "INV::delegateBySig: signature expired");
